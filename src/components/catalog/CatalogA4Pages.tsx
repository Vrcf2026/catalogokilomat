    ...
    <div ref={ref} className="h-full w-full relative overflow-hidden">
      ...
      <div className="h-full flex flex-col items-center justify-center relative z-10 px-8">
        <div className="absolute top-6 left-0 right-0 flex flex-col items-center">
          <img src={kilomatLogo} alt="Logótipo Kilomat" className="h-28 w-28 object-contain drop-shadow-lg" />
...
export const CatalogContactsPage = forwardRef<HTMLDivElement, {
  ...
  return (
    <div ref={ref} className="h-full w-full relative overflow-hidden" style={{ background: theme.gradient }}>
      ...
      <div className="h-full flex flex-col items-center justify-center relative z-10 px-8">
        <img src={kilomatShield} alt="Escudo Kilomat" className="h-40 w-40 object-contain drop-shadow-lg mb-6" />
        ...
        <div className="absolute bottom-6 left-0 right-0 px-8 flex flex-col items-center gap-1 text-center">
          ...
          <p className="text-white/80 text-[9px] leading-snug max-w-md">Todos os preços apresentados incluem IVA à taxa legal em vigor.</p>
          <p className="text-white/80 text-[9px] leading-snug max-w-md">Os preços são meramente indicativos e podem sofrer alterações sem aviso prévio.</p>
          <p className="text-white/80 text-[9px] leading-snug max-w-md">As imagens apresentadas são meramente ilustrativas.</p>
        ...
        <div className="flex items-center justify-between shrink-0" style={{ height: headerH, marginBottom: gapSize, paddingBottom: gapSize, borderBottom: "1px solid #e5e5e5" }}>
          <div className="flex items-center" style={{ gap: 8 }}>
            {brandLogo ? (
              ...
              <img src={kilomatLogo} alt="Logótipo Kilomat" style={{ height: logoH, width: logoH }} className="object-contain" />
            )}
